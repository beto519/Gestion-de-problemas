...
a38a16d0-767a-11eb-abe2-cecd029e558e:1-135971236';
...
CREATE TABLE `CentrosTrabajo` (
  `idCentrosTrabajo` int NOT NULL AUTO_INCREMENT,
  `clave` varchar(250) DEFAULT NULL,
  `nombreC` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`idCentrosTrabajo`)
...
INSERT INTO `CentrosTrabajo` VALUES (1,'001','Maquinas'),(3,'002','Papeleria'),(4,'003','Oficina 265'),(5,'004','Productos');
...
-- Dump completed on 2022-05-09 19:46:04
