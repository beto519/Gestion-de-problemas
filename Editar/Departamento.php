...
$buscarCentroTrabajo = "SELECT * FROM Departamentos where clave ='$claveDepartamento'";
...
$nombreBusqueda = $CentrosTrabajoEdicion['nombreD'];
?>
<?php
...
if (isset($_POST['editar_send'])) {
    ...
    if (!isset($error)) {
        ...
        $queryEdituser = sprintf(
            "UPDATE Departamentos SET clave='%s', nombreD='%s' WHERE clave =%d",
