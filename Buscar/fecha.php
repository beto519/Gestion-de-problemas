...
if (isset($_POST['buscar_send'])) {
  ...
  include("./../Reportes/FiltroFecha.php");
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid">
          <h1 class="mt-4">Buscar por fecha</h1>
          ...
          <form action="./../Reportes/FiltroFecha.php" method='post'>
              <div class="user-details">
              <div class="input-box">
                  <span class="details">Fecha inicio</span>
        

                  <input type="text" id="fechaIncial" name="fechaIncial" value="<?php if (isset($_POST['fechaIncial'])) echo $_POST['fechaIncial']; ?>">
                </div>


                <div class="input-box">
                  <span class="details">Fecha final</span>
           
                  <input type="text" id="fechaFinal" name="fechaFinal" value="<?php if (isset($_POST['fechaFinal'])) echo $_POST['fechaFinal']; ?>">
                </div>
