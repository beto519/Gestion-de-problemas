...
include("./../Reportes/FiltroEmpleado.php");
}
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid">
          ...
          <form action="./../Reportes/FiltroEmpleado.php" method='post'>
              <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  <select class="caja-departamento" id="empleado" name="empleado" onchange="cambio()">
                  ...
                  <input type="hidden" id="nombreE" name="nombreE" value="<?php if (isset($_POST['nombreE'])) echo $_POST['nombreE']; ?>">
                </div>
