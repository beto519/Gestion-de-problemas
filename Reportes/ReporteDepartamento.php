...
if ($_SESSION['rol'] == 'Admin') {
    ...
    where Problemas.idDepartamento = '$claveDepartamento' ORDER BY Problemas.claveProblemas ASC
    ";
    ...
    Inner join empleados on empleados.numeroEmpleado = Problemas.idEmpleado
    Inner join CentrosTrabajo on CentrosTrabajo.clave = Problemas.idCentroTrabajo
    where (Problemas.idEmpleado = '$codigoE') AND (Problemas.idDepartamento = '$claveDepartamento') ORDER BY Problemas.claveProblemas ASC ";
    ...
    where Problemas.estadoP = '$EstadoProblemas' and  Problemas.idDepartamento = '$claveDepartamento'  ORDER BY Problemas.claveProblemas ASC";
