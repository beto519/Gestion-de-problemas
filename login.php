...
if(isset($_POST['iniciarsesion'])) {
  ...
  $queryLogin = sprintf("SELECT idempleados, numeroEmpleado, nombre,correo,usuario, contraseña,departamento FROM empleados WHERE numeroEmpleado = '%s' AND contraseña = '%s'",
...
<div class="wrapper">
    ...
    <div class="centrar">
         <a href="registrar.php">Registrarte</a> </div>
</div>
</body>
</html>